...
class ParserTest(unittest.TestCase):
    def setUp(self):
        ...
        self.tokens = {
            ...
            TokenType.INEQUALITY: TokenOsu(
                TokenType.INEQUALITY, '!=', '!=', 1),
            TokenType.SEMICOLON: TokenOsu(TokenType.SEMICOLON, ';', ';', 1)
        }
    ...
    def test_int_statement(self):
        self.parser.tokens = [
            ...
            self.tokens[TokenType.SEMICOLON]
        ]

        self.assertEqual(
            self.parser.parse()[0],
            ExpressionStatement(Literal(self.tokens[TokenType.INT]))
        )
    ...
    def test_id_statement(self):
        ...
        self.assertEqual(
            self.parser.parse()[0],
            ExpressionStatement(Variable(self.tokens[TokenType.IDENTIFIER]))
        )
    ...
    def test_asterisk(self):
        ...
        self.assertEqual(
            ...
            ExpressionStatement(
                Binary(
                    Variable(self.tokens[TokenType.IDENTIFIER]),
                    self.tokens[TokenType.ASTERISK],
                    Literal(self.tokens[TokenType.INT])
                )
            )
