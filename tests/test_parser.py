...
class ParserTest(unittest.TestCase):
    ...
    #     self.parser.tokens = [self.tokens[TokenType.INT], self.tokens[TokenType.SEMICOLON]]
    #
    #     self.assertEqual(
    #         self.parser.parse(),
    ...
    #     self.parser.tokens = [self.tokens[TokenType.IDENTIFIER], self.tokens[TokenType.SEMICOLON]]
    #
    #     self.assertEqual(
    #         self.parser.parse(),
